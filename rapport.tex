...
\begin{proof}
	...
	\[
		...
		\end{array}
	\]
	D'où $F_{\beta_{i-2}}^{+}\dots F_{\beta_{1}}^{+}(V,f)\approx F_{\beta_{i-1}^-}(L_{\beta_{i}})$, et en itérant ce raisonnement : $V\approx F_{\beta_{1}}^-F_{\beta_2}^-\dots F_{\beta_{i-1}}^-(L_{\beta_i})$.
