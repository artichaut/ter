...
Considérons la représentation $(\widetilde V, \widetilde f)$ où $\widetilde V = \Ker p_{V}^{\alpha}$ et $\widetilde{f}$ est trivialement constituées de fonctions nulles. On nomme $\varphi$, le morphisme de $(V,f)$ dans $(\widetilde{V},\widetilde{f})$ défini tel que $\forall \gamma \in \Gamma_{0} \setminus \{\alpha\} $, on ait $\varphi_{\gamma}(V_{\gamma}) = \widetilde{V}_{\gamma} = \{0\}$ et $\varphi_{\alpha}(V_{\alpha}) = \widetilde{V}_{\alpha}$.    
