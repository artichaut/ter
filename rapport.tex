...
\begin{ex}[Une représentation]
	...
	\begin{center}
		\begin{tikzpicture}
			\node[sommet] (A) at (0,0) {};
			\node () at (.1,.5) {$\mathbb R^2$};
			\node[sommet] (B) at (2,0) {};
			\node () at (2.1,.5) {$\mathbb R^3$};
			\draw[fleche] (A) to (B);
			\node () at (1.1,.5) {$f$};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node () at (2.1,.5) {$\mathbb R^3$};
			\draw[fleche] (A) to (B);
			\node () at (1.1,.8) {$\begin{pmatrix}1&0\\0&1\\1&1\end{pmatrix}$};
		\end{tikzpicture}
	\end{center}
...
\begin{ex}[Une deuxième représentation]
	...
	\begin{tikzpicture}
			...
			\node () at (.1,-.5) {$\mathbb R^2$};
			\node[sommet] (B) at (2,0) {};
			\node () at (2.1,-.5) {$\mathbb R$};
			\draw[fleche] (A) to[bend left] (B);
			\node () at (1,.6) {$\begin{pmatrix}1&2\end{pmatrix}$};
			\draw[fleche] (B) to[bend left] (A);
			\node () at (1,-.85) {$\begin{pmatrix}0\\1\end{pmatrix}$};
			\draw[fleche] (A.north) arc (0:348:.5);
...
\begin{ex}[Une représentation indécomposable plus grosse]
	...
	\begin{tikzpicture}
			\node[sommet] (A) at (0,0) {};
			\node () at (0,-.35) {$\mathbb R$};
			\node[sommet] (B) at (2,0) {};
			\node () at (2,-.35) {$\mathbb R$};
			\draw[fleche] (A) to[bend left] (B);
			\node () at (1,.5) {$1$};
...
\begin{center}
	\begin{tikzpicture}
			...
			\node () at (0,-.35) {$\mathbb R$};
			\node[sommet] (B) at (2,0) {};
			\node () at (2,-.35) {$\left\{ 0 \right\}$};
			\draw[fleche] (A) to[bend left] (B);
			\node () at (1,.5) {$0$};
			\draw[fleche] (A) to[bend right] (B);
			\node () at (1,-.5) {$0$};
			\node[sommet] (C) at (4,0) {};
			\node () at (4,-.35) {$\left\{ 0 \right\}$};
			\node[sommet] (D) at (6,0) {};
			\node () at (6,-.35) {$\mathbb R$};
			\draw[fleche] (C) to[bend left] (D);
			\node () at (5,.5) {$0$};
			\draw[fleche] (C) to[bend right] (D);
			\node () at (5,-.5) {$0$};
		\end{tikzpicture},
	\end{center}
dont la somme directe n'est pas égale à $(V,f)$. Ainsi $(V,f)$ est une représentation indécomposable.
\end{ex}
