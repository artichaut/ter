...
\end{array}
	\]
Or $W$ est engendré par les applications $\sigma_\gamma$, on a donc que $W$ préserve la forme quadratique $B$. Le point 3 suit du point 4, nous l'admettrons dans la suite du document.
\end{proof}
\begin{prop}
