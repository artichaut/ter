...
\[
\begin{array}{ll}
  F^{-}_{\beta}(\varphi_{\beta}) \circ g_{l_{i}}(x) &= F^{-}_{\beta}(\varphi_{\beta})((0, \dots, x, \dots, 0) + \Img \tilde{h}) \\
...
\end{array}
	...
	Passons à la preuve du point 5. Pour cela, supposons que $(V,f)$ est de la forme $F_{\beta}^{-}(W,g)$
\end{proof}
